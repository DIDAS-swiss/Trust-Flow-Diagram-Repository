...
### [`sport/`](./sport)
Flows for skydiving: the Swiss Skydive licence issued with the e-ID, rigger licences by level and accident expert certificates, a reserve repack issued by a rigger and valid for one year, and licence, insurance and repack presented together at a drop zone.
